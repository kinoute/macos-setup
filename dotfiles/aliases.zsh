...
alias safarihistory="sqlite3 ~/Library/Safari/History.db \"SELECT datetime(V.visit_time+978307200, 'unixepoch', 'localtime') AS datetime, I.url, V.title FROM history_visits V LEFT JOIN history_items I ON V.history_item = I.id ORDER BY visit_time DESC LIMIT 1000;\""
